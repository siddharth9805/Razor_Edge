        ...
        <>
            <div id='home' className={styles.backgroundFrame}>
                ...
                <div className={`${"flex flex-column align-items-center justify-content-center h-screen"}`}>
                    ...
                    <Button label='View Offers' className={`${'sm:border-round-lg sm:pt-3 sm:pb-3 sm:pr-7 sm:pl-7 sm:font-semibold mt-7'} ${styles.book_button}`} onClick={redirectToUrl}></Button>
                </div>
            </div>
        </>
    )
